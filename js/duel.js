...
Duel.prototype.updateRobotStats = function (robot, prefix) {
    ...
    document.getElementById(prefix + 'progress').style.width = Math.round(robot.data.power) + "%";
    document.getElementById(prefix + 'progress').textContent = Math.round(robot.data.power) + "%";
